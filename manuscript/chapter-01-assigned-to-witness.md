...
In older histories, the sample would have been tested for signs of illness. Trinity still captured those values. It simply cared about different results first. The live display filled with stress response, emotional volatility, impulse control, and compliance markers.
...
Grateful for controlled air, measured light, sterile water, and predictable days. Grateful despite the ugliness beneath the system and the pain it kept out of sight.

They called the elevators Skylarks after old-world songbirds associated with ascent and dawn. Trinity liked the name because it made separation sound like freedom.

The name appeared on every wall in soft blue lettering: RISE ABOVE SUFFERING.

From the upper levels, she could avoid hunger, disease, deprivation, pain, and loneliness. Trinity had not defeated those things. It had moved them somewhere else.

The elevator took thirty seconds to lift her toward the monitoring towers. The towers were built for separation. Several thousand feet above Trinity's lower levels, they kept the miners below out of sight.
...
There was nothing performative about him. No Chanakya polish. No Kubera theater. Just force held in reserve, disciplined into stillness.
